...
const NO_TOPIC: Record<string, string> = {
  ...
  'go/ruthless': 'โหมดโหดของหมากล้อมเป็นคู่ต่อสู้ไว้ท้าทาย ไม่ใช่อัลกอริทึมใหม่ — เป็น MCTS+RAVE ที่เปิดของทุกอย่าง',
  'go/learner': 'ตัวเรียนรู้ข้ามเกมของหมากล้อม — ตำราเปิดหมาก + Last Good Reply ทับบน MCTS เดิม ยังไม่ได้เขียนหน้าความรู้',
  'go/rl': 'ตัวฝึกน้ำหนักเองด้วย REINFORCE — ยังไม่ได้เขียนหน้าความรู้ รอดูผลการฝึกก่อน',
  'go/kyu1': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu2': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu3': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu4': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu5': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu6': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu7': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu8': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
  'go/kyu9': 'ระดับความเก่งของคู่ต่อสู้ ไม่ใช่อัลกอริทึมใหม่ — เป็นอัลกอริทึมเดิมที่ปรับเวลาคิดกับอัตราพลาด ผู้ใช้ขอไม่ให้ใส่ในหน้าความรู้',
}
