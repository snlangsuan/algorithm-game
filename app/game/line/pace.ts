...
export interface SpeedOption {
   ...
   * ฟิสิกส์ยังเดินก้าวละ 1/60 วินาทีเท่าเดิม เวลาต่อรอบจึงเหมือนเดิมเป๊ะไม่ว่าจะตั้งช้าหรือเร็ว
   */
  scale: number
}

export const SPEEDS: SpeedOption[] = [
  { value: 0, label: 'ช้า', scale: 0.4 },
  { value: 1, label: 'ปกติ', scale: 1 },
  { value: 2, label: 'เร็ว', scale: 2 }
]
